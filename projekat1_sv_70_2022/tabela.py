...
class Tabela(object):
    ...
    def print_state(self, new_table):
        ...
        # print(self._tabela)
        # print(dynamic_heuristic_evaluation_function(dict_to_list_of_lists(self._tabela)))
    ...
    def count_discs(self):
        ...
        # print("Current score")
        # print("-----------------")
        # print("Player black: " + str(blacks))
        # print("Player white: " + str(whites))
        # print("-----------------")
        return [blacks, whites]

    def count_discs_copy(self):
        copied_dict = copy.deepcopy(self._tabela)
        blacks = 0
        whites = 0
    ...
    def lost_options_copy(self, provera_tabele):
        copied_dict = copy.deepcopy(self._tabela)
        for x in provera_tabele.items():
            for y in copied_dict.items():
                if y != x:
                    return False
        return True
